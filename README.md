...
- MUX2 potentiometers are reversed so clockwise/upward travel increases MIDI CC values, with 8-sample moving average smoothing and deadband jitter suppression.
