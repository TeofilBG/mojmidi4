...
- MUX2 potentiometers are reversed so clockwise/upward travel increases MIDI CC values, with 8-sample moving average smoothing, deadband jitter suppression, and raw readings below 3 forced to 0.
