...
potentiometer 2 to choose the CC press value/velocity precisely; every MIDI
value step is shown and saved with that pad. Moving any other potentiometer selects that pot instead; all 6 pots stay as
