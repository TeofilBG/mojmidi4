...
namespace Graphics {
  const uint8_t TITLE_X = 10;
  const uint8_t TITLE_Y = 14;
  const uint8_t CHANNEL_X = 32;
  const uint8_t CHANNEL_Y = 40;
  const uint8_t ENC1_X = 1;
  const uint8_t ENC2_X = 72;
  const uint8_t ENCODER_Y = 63;
  const uint8_t EDIT_LABEL_X = 1;
  const uint8_t EDIT_LABEL_Y = 17;
  const uint8_t EDIT_NOTE_X = 76;
  const uint8_t EDIT_NOTE_Y = 43;
  const uint8_t EDIT_STATUS_X = 1;
  const uint8_t EDIT_STATUS_Y = 63;
